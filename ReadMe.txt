...
1.  NeocisAssessP1.py is designed for Part 1.
Two modules are imported: tkinter and math.
A blue circle is drawn when user presses and drags mouse's left button.
...
2.  NeocisAssessP2.py is designed for Part 2.
...
3.  myscript.py is used to generate .exe on windows.
